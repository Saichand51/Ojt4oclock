...
public class DriverScript {
	...
	{
		//create reference object for accessing excel util methods
			...
			if(excel.getCellData("MasterTestCases", i, 2).equalsIgnoreCase("Y"))
			{
				...
				for(int j =1;j<=excel.rowCount(TCModule);j++)
				{
					...
					catch(Throwable e)
					{
						...
						FileUtils.copyFile(screen, new File("D:\\Ojt4oclock\\ERP_MAVEN\\screen\\"+Description+FunctionLibrary.generateDate()+".png"));
						ModuleStatus = "False";
						break;
					}
